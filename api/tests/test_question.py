...
def test_get_question():
    ...
    assert "incorrect_answer_1" in data and isinstance(
        data["incorrect_answer_1"], str
    )
    assert "incorrect_answer_2" in data and isinstance(
        data["incorrect_answer_2"], str
    )
    assert "incorrect_answer_3" in data and isinstance(
        data["incorrect_answer_3"], str
    )
